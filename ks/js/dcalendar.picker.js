...
+function ($) {
	...
	var months = ['一月','二月','三','四月','五月','六月','七月','八月','九月','十月','十一月','十二月'],
		...
		DCalendar = function(elem, options) {
			...
			if(options.mode === 'calendar')
				...
				this.tHead = $('<thead><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th></th>日</th><th>一</th><th>二</th><th>三</th><th>四</th><th>五</th><th>六</th></tr></thead>');
